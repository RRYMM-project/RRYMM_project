...
function createSliderSection() {
    ...
    const titleDiv = createTitleDiv("Let's explore developer tools together", "slider-title");
    ...
    const swiperBtnWrNext = createDivWithClassAndId("swiper-button-wrapper", null);
    ...
    const swiperBtnWrPrev = createDivWithClassAndId("swiper-button-wrapper", null);
    ...
    sliderDiv.appendChild(swiperPagination);
    sliderDiv.appendChild(swiperBtnWrNext);
    sliderDiv.appendChild(swiperBtnWrPrev);
